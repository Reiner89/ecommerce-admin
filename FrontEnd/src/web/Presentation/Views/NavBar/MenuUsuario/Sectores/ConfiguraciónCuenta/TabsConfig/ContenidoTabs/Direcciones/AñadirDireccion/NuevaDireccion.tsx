...
const NuevaDireccion = () => {
    ...
    return (
        <div>
            <Button onPress={onOpen} className='bg-[#55ccea] text-[#fff] '> Agregar Dirección</Button>
            <Modal isOpen={isOpen} onOpenChange={onOpenChange} >
                <ModalContent className="w-[50vw] h-[50vh] max-w-none ">
                    {(onClose) => (
                        <>
                            <ModalHeader className="flex flex-row gap-1 items-center space-x-10 px-10 "> <TbGps size={50} className='mr-[20px]' /> <p className=' font-extralight text-[30px]'>  Añade una nueva dirección</p></ModalHeader>
                            <ModalBody>
