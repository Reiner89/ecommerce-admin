...
import { FaChevronRight,FaMale } from "react-icons/fa";
  ...
  return (
    <div className="space-y-4 ">
        <div className="bg-gradient-to-r from-cyan-500 to-[#a0e1f3] rounded-tr-3xl flex items-center h-[50px] pl-[20px] space-x-4 shadow-xl">
            <FaMale size={35} />
            <h1 className="text-[25px] w-[300px]">Hombre</h1>
                    ...
                    <h1 className="font-bold text-[17px] relative group hover:text-blue-500 ">
                        ...
                        <ul className="space-y-2 text-[14px]">
                            ...
                            <Link to="/lista-productos">
                                ...
                                <FaChevronRight
                                    className="absolute top-1 left-[-20px] opacity-0 transition-all duration-300 group-hover:left-0 group-hover:opacity-100 text-blue-500"
                                />
                             </Link>   
                            </li>
