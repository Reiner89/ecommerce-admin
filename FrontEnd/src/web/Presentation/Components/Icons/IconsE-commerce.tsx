...
export const SearchIcon: React.FC<SearchIconProps> = ({ size = 24 }) => {
    return (
        <svg
            width={size}  
            height={size} 
        ...
        >
            <path
                d="M11 4a7 7 0 107 7 7 7 0 00-7-7zm0 12a5 5 0 115-5 5 5 0 01-5 5zm9.71 4.29l-3.4-3.39a1 1 0 00-1.42 1.42l3.39 3.4a1 1 0 001.42-1.42z"
                fill="currentColor"
            />
        </svg>
    );
